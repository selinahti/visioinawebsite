...
By using OTUS you agree to the following. App Store purchases are additionally
governed by Apple's standard [Licensed Application End User License
...
Questions? Email [{{ site.company.email }}](mailto:{{ site.company.email }}).
